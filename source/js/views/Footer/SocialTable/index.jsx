  ...
  return (
    <div className='social-table'>
      ...
      <div className='footer-about-site'>
        ...
        <pre>{'AM4 - это большая коллекция игровой информации, помогающей геймерам со всего мира быть в курсе последних новостей игрового мира. Курлык!'}</pre>
      </div>
      <button
        onClick={() => alert('This functionality is missing.')}
        className='button-write-us'>{'Написать нам'}
      </button>
    </div>
  )
}
