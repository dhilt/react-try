...
module.exports.getArticleById = (req) =>
...
module.exports.getArticles = (req) =>
  new Promise((resolve, reject) => {
    // Collect params
    let params = {}
...
module.exports.createArticle = (req) =>
...
module.exports.updateArticle = (req) =>
  AuthHelper.doAuthorize(req.headers.authorization)
  // params validation
  .then(user => {
    if (user.id !== 1) {
...
module.exports.deleteArticle = (req) =>
  AuthHelper.doAuthorize(req.headers.authorization)
  // params validation
  .then(user => {
    if (user.id !== 1) {
